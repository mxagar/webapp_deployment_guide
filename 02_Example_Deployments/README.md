...
- [Simple Web App Deployment Guide](#simple-web-app-deployment-guide)
  - [Goal](#goal)
  - [Project Scope](#project-scope)
  - [Functional Components](#functional-components)
    - [1. Backend](#1-backend)
    - [2. Frontend](#2-frontend)
    - [3. SQL Database](#3-sql-database)
    - [4. Blob/Object Storage](#4-blobobject-storage)
    - [5. API](#5-api)
  - [Recommended Minimal Architecture](#recommended-minimal-architecture)
    - [Version 1: Minimal but realistic](#version-1-minimal-but-realistic)
    - [Why these choices?](#why-these-choices)
      - [Caddy as reverse proxy](#caddy-as-reverse-proxy)
      - [Gunicorn as app server](#gunicorn-as-app-server)
      - [Flask-Login for auth](#flask-login-for-auth)
  - [Extended Architecture](#extended-architecture)
    - [Version 2: Add realism gradually](#version-2-add-realism-gradually)
    - [Why Redis?](#why-redis)
    - [Why RQ?](#why-rq)
  ...
  - [Why staging matters](#why-staging-matters)
  - [Configuration Strategy](#configuration-strategy)
  - [Suggested Deployment Targets](#suggested-deployment-targets)
    - [How to think about them](#how-to-think-about-them)
  ...
  - [Recommended Libraries and Tools](#recommended-libraries-and-tools)
    - [Core app](#core-app)
    - [Reverse proxy](#reverse-proxy)
    - [Authentication](#authentication)
    - [Optional later additions](#optional-later-additions)
    - [CI/CD](#cicd-1)
  - [What this project teaches well](#what-this-project-teaches-well)
  - [What is intentionally not the focus](#what-is-intentionally-not-the-focus)
  - [Recommended Learning Progression](#recommended-learning-progression)
    - [Phase 1](#phase-1)
    - [Phase 2](#phase-2)
    - [Phase 3](#phase-3)
    - [Phase 4](#phase-4)
